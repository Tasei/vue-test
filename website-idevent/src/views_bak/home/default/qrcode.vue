...
<div class="qr-bg" v-if="user">
    <div class="qr-wrapper">
		<div class="my-qrcode">
			...
			<p class="my-qrcode-desc">扫一扫上面的二维码即可签到参会</p>
		</div>
    ...
    <bg-bottom-bar v-if="_IS_('bg2017')"></bg-bottom-bar>
    <bottom-bar v-else :active="'my'"></bottom-bar>
</div>
</template>
<script>
import iButton from "iButton"
import BottomBar from "./components/bottom_bar"
import BgBottomBar from "../bg2017/components/bottom_bar"
	export default {
		components: {
			BottomBar, iButton, BgBottomBar
		},
		created() {
