                    ...
                    <table class="table">
                        <tbody>
                            <tr v-for="(p, index) of award_list">
                                <td width="119">
                                    <div class="avatar" :style="{backgroundImage: 'url('+ p.headimgurl + ')' }"></div>
                                </td>
                                <td class="name" v-if="p.user_name">{{p.user_name}}</td>
                ...
                <div v-else>
                    ...
                    <div class="text-center avatar-item" v-if="trans">
                        <div class="avatar-list">
                            <img :src="trans.headimgurl" />
                        </div>
                        <h3 class="text-dark" v-if="trans.user_name">{{trans.user_name}}</h3>
