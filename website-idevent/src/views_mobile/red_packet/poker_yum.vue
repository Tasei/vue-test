    ...
    <div>
        <div v-if="!take" class="poker">
            ...
            <mt-popup class="popup-result" v-model="popup" popup-transition="popup-fade">
                <div class="content-result">
                    <div v-show="result == 1" class="is is-tick" @click="openRedPacket"></div>
        ...
        <div v-else class="record">
            <div class="record-h">
                <div class="money">
                    <h5>- 不忘初心 进无止境 -</h5>
                    <h1 v-if="money > 0">{{money}}<small>元</small></h1>
                    <h1 v-else>已抢光</h1>
                </div>
            </div>
                ...
                <table class="table">
                    <tbody>
                        <tr v-for="p of record_list">
                            <td>{{p.invitation.user_name ? p.invitation.user_name : (p.invitation.weixin ? p.invitation.weixin.nickname : '')}}</td>
...
export default {
    ...
    computed: {
        ...
        RedPacket() {
            if (this.meeting.alias == 'yumchina2017') {
...
<style lang="less" scoped>
    ...
    .popup-result {
        ...
        .content-result {
            ...
            .is-tick {
                padding-top: 101.33%;
                background-image: url("./images/is-tick.png");
            }
            .is-again {
                padding-top: 75.47%;
