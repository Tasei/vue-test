<template>
    <div>
        ...
        <div class="row" v-if="_IS_('chery2017')">
            <div class="cols large-12">
                <p class="bg-warning tips">
...
<script>
    export default{
        ...
        locales: {
            en: {
                tips: "Due to the limited number of rooms, please complete your reservation as soon as possible",
                price: "All rooms for 580 yuan / night, including breakfast for 2",
            },
            zh: {
                tips: "由于房间数量有限，请尽快完成房间预定",
                price: "大床/双床房均为580元/晚, 含双早",
            }
        }
    }
</script>
