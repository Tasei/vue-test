...
<div>
    <div class="fd-index" v-if="user">
        ...
        <div class="list-box">
            <ul class="list-group index-list">
                <li class="list-group-item">
                    <i class="index-icon index-icon-interact"></i>
                    <router-link :to="{name:'home_page',query: {page: 'interact'}}">
                        <h5>现场互动</h5>
                        <p class="list-details">参加大会现场互动环节</p>
                    </router-link>
                    <!--<a @click="iPhoto">-->
                        <!--<h5>现场互动</h5>-->
                        <!--<p class="list-details">参加大会现场互动环节</p>-->
                ...
                <li class="list-group-item">
                    ...
                    <router-link :to="{name:'home_page',query: {page: 'venue'}}">
                        <h5>会议酒店</h5>
                ...
                <li class="list-group-item">
                    <i class="index-icon index-icon-flight"></i>
                    <a :href="sendAirImg">
                        <h5>送机安排</h5>
                        <p class="list-details">查看送机安排</p>
                    </a>
                </li>
                <li class="list-group-item">
                    ...
                    <!--<router-link :to="{name:'home_page', query: {page: 'common'}}">-->
                        <!--<h5>晚宴座位图</h5>-->
                        <!--<p class="list-details">查看晚宴座位安排</p>-->
                    <!--</router-link>-->
        ...
        <bottom-bar class="ford-bottom-bar"></bottom-bar>
    </div>
...
import BottomBar from "./components/bottomBar"
    export default{
        data() {
            return{
                sendAirImg:require('./images/songji.png'),
                seatImg:require('./images/seat.png')
            }
        },
        computed: {
            user() {
        ...
        methods: {
            iPhoto(){
//                Toast('敬请期待......')
                window.location.href = 'https://iphoto.idevent.cn/?mid=10124';
            },
        }
    }
</script>
