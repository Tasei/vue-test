    ...
    <div class="login-box" :class="{'login-box-pc': !isMobile}" :style="styleObj">
        ...
        <div class="m-login-page">
            ...
            <div class="m-login-form">
                ...
                <input v-else type="text" class="form-control m-login-code 222"  :placeholder="$t('login.code_placeholder')"
                       v-model="invitationCode">
                ...
                <div class="form-group">
                    <p>温馨提醒：</p>
                    <p>1、如您为长安福特员工，请在“邀请码”内填写员工编号，如：CF1000</p>
                    <p>2、如您为长安福特经销商，请在“邀请码”内填写经销商销售代码+字母（A/B），如：同一家经销商第一位参会人A02030A，第二位参会人A02030B</p>
                </div>
