    ...
    <div class="login-box" :class="{'login-box-pc': !isMobile}" :style="styleObj">
        ...
        <div class="m-login-page">
            ...
            <div class="m-login-form">
                ...
                <i-button v-if="$lang=='en'" type="button" :on-ok="login" class="btn btn-primary btn-lg m-login-btn purple-color">
                    Login
                </i-button>
                <i-button v-else type="button" :on-ok="login" class="btn btn-primary btn-lg m-login-btn purple-color">
                    登录
                </i-button>

                <div class="login-tips">
                    <p class="font-bold text-center"><a @click="changeLang('zh')">中文</a> | <a @click="changeLang('en')">English</a></p>
                </div>
