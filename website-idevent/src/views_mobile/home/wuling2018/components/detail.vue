        ...
        <div v-if="hotelInfo">
            ...
            <ul class="list-group hotel-contact">
                <li class="list-group-item hotel-name">
                    <h3 class="name_cn">{{hotelInfo.name}}</h3>
                    <span v-if="hotelInfo.name_en" class="name_en">{{hotelInfo.name_en}}</span>
                </li>
                ...
                <li class="list-group-item" v-if="hotelInfo.address">
                    <a
                        :href="'http://map.baidu.com/?newmap=1&ie=utf-8&s=s%26wd%3D' +hotelInfo.name">
        ...
        <iui-block>
            <div v-if="hotelInfo && hotelInfo.introduce">
                ...
                <div class="hotel-introduce-content">
                    <img :src="hotelInfo.facilities" alt="" style="width: 100%">
                </div>
            </div>
