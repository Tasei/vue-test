<template>
    <div class="col-sm-12">
        ...
        <div class="i-dot-steps-container">
            <h5 class="i-dot-steps-title text-primary">{{surveyName}}</h5>
        ...
        <div v-else>
            <the-form-squire v-if="surveyName == '其他调研'" :form-list="formList" :cancel-btn="hasRegInfo"></the-form-squire>
            <the-form v-else  :form-list="formList" :cancel-btn="hasRegInfo"></the-form>
        </div>
    </div>
</template>
<script>
...
//    import steps from "../../../register/components/steps"
    ...
    import theFormSquire from "./components/questionnaireSquire/_form"
    import { Indicator, Toast } from 'mint-ui';
    import marked from 'marked'

    export default{
        components: {theForm,theFormSquire},
        data() {
            return {
                surveyName:'',
                formList: [],
        ...
        created() {
            this.surveyName = this.$route.params.name
