<template>
    <div class="row register-form" v-if="isFormVisible()">
        <fieldset>
...
<script>
    ...
    import formLevelSelect from "./form/levelSelect"
    import formDate from "./form/date"
    import formFileUploader from "./form/fileUploader"
    import formFlightNo from "./form/flightNo"
    import formTrainNo from "./form/trainNo"
